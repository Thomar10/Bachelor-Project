...
func (s Simple_Sharing) SetField(field finite.Finite) {
	panic("implement me")
}

func (s Simple_Sharing) ComputeFunction(m map[int][]*big.Int, i int) []*big.Int {
	panic("implement me")
}
...
func (s Simple_Sharing) ComputeResult(ints []*big.Int) int {
	panic("implement me")
}
